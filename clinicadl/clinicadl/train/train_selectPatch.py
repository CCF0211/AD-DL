...
def train_select_patch(params):
    ...
    for fi in fold_iterator:
        ...
        train(model, train_loader, valid_loader, criterion, optimizer, False, log_dir, model_dir, params, fi, cnn_index,
              num_cnn, train_begin_time=train_begin_time)
        ...
        metric_dict = test_cnn(params.output_dir, valid_loader, "validation", fi, criterion, cnn_index, params,
                               gpu=params.gpu, train_begin_time=train_begin_time)
